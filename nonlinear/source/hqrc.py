...
def get_IPC(qparams, ipcparams, length, logger, nqrc=1, gamma=0.0, ranseed=-1, Ntrials=1, savedir=None, \
    posfix='capa', type_input=0, combine_input=1, label=''):
    ...
    for n in range(Ntrials):
        ...
        model = HQRC(nqrc=nqrc, gamma=gamma, sparsity=1.0, sigma_input=1.0, type_input=type_input, combine_input=combine_input)
