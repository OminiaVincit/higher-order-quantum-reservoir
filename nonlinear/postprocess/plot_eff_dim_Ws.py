...
if __name__  == '__main__':
    ...
    parser.add_argument('--folder', type=str, default='../../../data/hqrc/dynamics_rand/eff')
    ...
    ax.plot(xs, ys, linewidth=2, color=col, alpha=0.8, label='T={}'.format(length))
    ...
    if os.path.isdir(fig_folder) == False:
        os.mkdir(fig_folder)
    outbase = os.path.join(fig_folder, 'eff_dim_prefix_{}_gam_{}_len_{}'.format(prefix, gamma, length))
